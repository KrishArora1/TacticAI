...
function Sidebar({
  ...
  <img 
    src="https://media-hosting.imagekit.io//2cb789be3b3448f8/Logo.png?Expires=1834878797&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=Yz4XlEub09QQclsfJUi8-WLG3Txz~haW2Y6rCmoww0R1cfjeyB6udASWXDlmplCMHEF-FB8Kr2KyqsCLMczH8NsoI6gQ0Q5m4Fe5~YegaizcOCNhJH5ZCyr3-jFoL6KoeYAZAEGjD1boaElZRyxTTzdK3D9d3S-o1cj22zyMEkT1sfMc8VHqUtaumHHq3nl5Y~FoNB7M5nJLeIefaU-X4u2QW0x8vB3~1luQ8vh65VXLkUykkMXHTMfxYtHKxnT~3oXYONQeOTvSXP7glyOrbQsd3XBC2Z0RIKnHKVEExzoyO-ukG1ksIKRsUuSledtjtjNRX~wtDRYQrDrRz7OTjw__" 
    alt="description" 
  ...
  {(handleClick, open) => {
    return (
      <React.Fragment>
        <a
          href="https://devpost.com/software/tacticai"
          className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
            pathname.includes("ecommerce") ? "" : "hover:text-gray-900 dark:hover:text-white"
          }`}
          onClick={handleClick} // Handle any other custom logic, if needed
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <svg
  ...
  {(handleClick, open) => {
    return (
      <React.Fragment>
        <a
          href="https://github.com/ankit06ch/TacticAI"
          className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
            pathname.includes("ecommerce") ? "" : "hover:text-gray-900 dark:hover:text-white"
          }`}
          onClick={handleClick} // Handle any other custom logic, if needed
  ...
  {(handleClick, open) => {
    return (
      <React.Fragment>
        <a
          href="https://regular-hydrangea-d6e.notion.site/TacticAI-1a2e2fc1fcde80f2b8fcf5c48d19d74c?pvs=4"
          className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
            pathname.includes("ecommerce") ? "" : "hover:text-gray-900 dark:hover:text-white"
          }`}
          onClick={handleClick} // Handle any other custom logic, if needed
